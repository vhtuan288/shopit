...
const UpdateProduct = ({match, history}) => {
    ...
    const {loading, error: updateError, isUpdated, updatedProduct} = useSelector(state => state.product);
    ...
    useEffect(() => {
        ...
        if (product && product._id !== productId) {
            ...
            setSeller(updatedProduct.seller)
            setStock(updatedProduct.stock)
            setOldImages(updatedProduct.images)
        } else {
