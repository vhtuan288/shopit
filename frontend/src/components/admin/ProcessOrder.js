...
const ProcessOrder = ({match}) => {
    ...
    const shippingDetails = shippingInfo && `${shippingInfo.adress}, ${shippingInfo.city},
                        ...
                        {loading ? <Loader /> : (
                            <div className="row d-flex justify-content-around">
                                ...
                                <div className="col-12 col-lg-3 mt-5">
                                    ...
                                    <button className="btn btn-primary btn-block" onClick={() => updateOrderHandler(order._id)}>Update Status</button>
                                </div>
                            </div>
                        )}
                    </Fragment>
